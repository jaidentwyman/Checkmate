...
export interface INotificationsService {
	...
	send: (notification: Notification, monitor: Monitor, monitorStatusResponse: MonitorStatusResponse, decision: MonitorActionDecision, notificationMessage?: NotificationMessage) => Promise<boolean>;
	sendDirectNotification: (notification: Notification, monitor: Monitor, monitorStatusResponse: MonitorStatusResponse, decision: MonitorActionDecision, notificationMessage?: NotificationMessage) => Promise<boolean>;
